...
function Education() {
  const education = [
    ...
    },
    {
      ...
      year: "Graduated 2019",
      desc: "Specialized in hydraulic systems, fluid mechanics, HEC-HMS, HEC-RAS, and predictive water modeling for sustainable engineering solutions.",
    },
    {
    ...
    },
    {
      ...
      school: "IBM",
      year: "2023",
      desc: "Hands-on training in IT support fundamentals with focus on AWS services, serverless computing, and cloud deployments.",
    },
    {
      title: "Certificate in Data Analytics",
      school: "IBM",
      year: "2024",
      desc: "Developed skills in data analysis, visualization, and reporting using Excel, SQL, and Python for business insights.",
    },
    {
      title: "Planned Certification: SQL Server Database Developer",
      school: "Microsoft",
      year: "In Progress",
      desc: "Focusing on database design, optimization, and management with Microsoft SQL Server to build scalable systems.",
    },
  ];
